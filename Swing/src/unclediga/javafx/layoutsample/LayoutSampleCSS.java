...
public class LayoutSampleCSS extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("Layout Sample CSS");
        stage.setWidth(800);
        stage.setHeight(500);
        ...
        scene.getStylesheets().add("unclediga/javafx/layoutsample/layoutstyles.css");
...
//        tilePane.setStyle("-fx-background-color: DAE6F3;");
        tilePane.getStyleClass().addAll("pane", "flow-tile");
